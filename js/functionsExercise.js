 ...
 */
let billTotal = Number(prompt("How much was your total bill?"));
let tipPercent = Number(prompt("What percent would you like to tip")) / 100;
let tip = (calculateTip(tipPercent, billTotal));
